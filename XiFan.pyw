...
class Main:
    def __init__(self):
        self.path = os.path.realpath(os.curdir)
        self.main_ui = QUiLoader().load(self.path + "\\ui\\XiFan.ui")
        self.settings_ui = QUiLoader().load(self.path + "\\ui\\settings.ui")
        self.pushButtons = [
    ...
    def init(self):
        # read options
        with open(self.path + "\\data\\options.json", "r", encoding="utf-8") as file:
        ...
        # read settings
        with open(self.path + "\\data\\ui.json", "r", encoding="utf-8") as file:
    ...
    def add(self):
        ...
        with open(self.path + "\\data\\options.json", "w", encoding="utf-8") as file:
    ...
    def save(self):
        try:
            ...
            with open(self.path + "\\data\\ui.json", "w", encoding="utf-8") as file:
